...
void window::DrawCircle(const int iX, const int iY, const int i1x, const int i1y, const drawstyle dsStyle) {
		const int iRadius = sqrt((i1y - iY)*(i1y - iY) + (i1x - iX)*(i1x - iX)) ;
    HRGN rgnTemp;
