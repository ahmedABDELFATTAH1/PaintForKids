...
class color {
  ...
  public:
	...
	if (a.ucRed == ucRed && a.ucGreen== ucGreen && a.ucBlue== ucBlue)
		return true ;
	else return false ;
...
const color WWHITE = color(255, 255, 255);
const color BBLACK = color(0, 0, 0);
...
const color BBLUE = color(0, 0, 255);
...
const color GGREEN = color(0, 255, 0);
...
const color RRED = color(255, 0, 0);
